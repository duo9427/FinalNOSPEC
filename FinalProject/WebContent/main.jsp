...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link rel="stylesheet" type="text/css" href="sdsdsd/bootstrap/css/bootstrap.min.css" />
  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
		...
		<!-- ==== HEADERWRAP ==== -->
	    <div id="headerwrap" id="home" name="home" style="background:url('sdsdsd/images/office.jpg') no-repeat center top; background-size: cover;">
		...
		<!-- ==== SECTION DIVIDER1 -->
		<section class="section-divider textdivider divider1" style="background:url('sdsdsd/images/bg/divider1.jpg');">
			<div class="container">
		...
		<div class="container" id="services" name="services">
			...
			<div class="row">
				...
				<br>
				<div class="col-lg-offset-2 col-lg-8">
					<img class="img-responsive" src="sdsdsd/images/iphone.png" alt="">
				</div><!-- col -->
			</div><!-- row -->
		</div><!-- container -->
		...
		<!-- ==== SECTION DIVIDER2 -->
		<section class="section-divider textdivider divider2" style="background:url('sdsdsd/images/bg/divider2.jpg');">
			<div class="container">
		...
		<br>
			<div class="row white centered">
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="sdsdsd/images/team/team01.jpg" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="sdsdsd/images/team/team02.jpg" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="sdsdsd/images/team/team03.jpg" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="sdsdsd/images/team/team04.jpg" height="120px" width="120px" alt="">
					<br>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 centered">
						<img class="img-responsive" src="sdsdsd/images/macbook.png" align="">
					</div>
					<div class="col-lg-4">
						<h2>We Are Hiring!</h2>
		...
		<!-- ==== SECTION DIVIDER3 -->
		<section class="section-divider textdivider divider3" style="background:url('sdsdsd/images/bg/divider3.jpg');">
			<div class="container">
		...
		<br>
			...
			<div class="row">	
				...
				<div class="col-md-4 ">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="sdsdsd/images/portfolio/folio01.jpg" alt="">
							<figcaption>
								<h5>DASHBOARD</h5>
						    ...
						    <div class="modal-dialog">
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
						          <p><img class="img-responsive" src="sdsdsd/images/portfolio/folio01.jpg" alt=""></p>
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="sdsdsd/images/portfolio/folio02.jpg" alt="">
							<figcaption>
								<h5>UI DESIGN</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="sdsdsd/images/portfolio/folio03.jpg" alt="">
							<figcaption>
								<h5>ANDROID PAGE</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
			...
			<div class="row">	
				<div class="col-md-4 ">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="sdsdsd/images/portfolio/folio04.jpg" alt="">
							<figcaption>
								<h5>PROFILE</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="sdsdsd/images/portfolio/folio05.jpg" alt="">
							<figcaption>
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="sdsdsd/images/portfolio/folio06.jpg" alt="">
							<figcaption>
								<h5>PHONE MOCKUP</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
		...
		<!-- ==== SECTION DIVIDER4 ==== -->
		<section class="section-divider textdivider divider4" style="background:url('sdsdsd/images/bg/divider4.jpg');">
			<div class="container">
		...
		<br>
			...
			<div class="row">
				<div class="col-lg-6 blog-bg">
					...
					<br>
						<p><img class="img img-circle" src="sdsdsd/images/team/team04.jpg" width="60px" height="60px"></p>
						<h4>Jaye Smith</h4>
				...
				<div class="col-lg-6 blog-bg">
					<div class="col-lg-4 centered">
					<br>
						<p><img class="img img-circle" src="sdsdsd/images/team/team03.jpg" width="60px" height="60px"></p>
						<h4>Michele Lampa</h4>
		...
		<!-- ==== SECTION DIVIDER6 ==== -->
		<section class="section-divider textdivider divider6" style="background:url('sdsdsd/images/bg/divider6.jpg');">
			<div class="container">
