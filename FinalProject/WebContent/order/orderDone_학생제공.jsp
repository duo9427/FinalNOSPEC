...
<table width="70%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="td_default" align="center"><b>guest</b> 님의 주문이
			안전하게 처리되었습니다.</td>
	</tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="td_default" height="35"> (321-987)<br>
						용산구 갈월동 갑을빌딩 303호
					</td>
				</tr>
				...
				<tr>
					...
					<td class="td_default" height="35"> 01021359876</td>
				</tr>
			</table>
	</tr>
	</td>
			...
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					<td height="35" class="td_default">
						<span class="a_default">옥문도</span>
					</td>
					<td height="35" class="td_default" align="center">
						<span  id = "price1">16000</span>원
					</td>
					<td height="35" class="td_default" align="center">
						<span id = "num1">1</span>권
					</td>
					<td height="35" class="td_default" align="center">
						<span>16000</span>원
					</td>
