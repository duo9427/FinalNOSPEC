...
public class OrderDTO {
	...
	public OrderDTO(int num, String userid, String gCode, String gName, int gPrice, String gImage, String gSize, String gColor,
			int gAmount,String orderName, String post1, String post2, String addr1, String addr2, String phone, String payMethod ,String orderDay) {
		super();
		this.num = num;
		this.userid = userid;
		this.gCode = gCode;
